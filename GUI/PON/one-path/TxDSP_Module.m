function [x_t, y_t, SigX, SigY, PAPR, sps] = TxDSP_Module(Params)
% TxDSP_Module: 
%
...
%   PAPR       : Peak-to-Average Power Ratio of the generated signal
    ...
    %% 4. Add Pilot Tones
%     ptfreList1 = [-2 -0 0 2]*scbw + [-1 -0 0 1]*grdbw;
    ptfreList1 = [-4 -2 2 4]*scbw + [-1 -1 1 1]*grdbw;

%     Params.cf = [-3*scbw-1.5*grdbw, -1*scbw-0.5*grdbw, 1*scbw+0.5*grdbw, 3*scbw+1.5*grdbw];
