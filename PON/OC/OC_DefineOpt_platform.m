function Opt = OC_DefineOpt_platform(Params, BaudRate, ER)
...
Opt.Tx.MZM.Vpi = Params.MZM.Vpi;
Opt.Tx.MZM.VpiDC = Params.MZM.VpiDC;
Opt.Tx.EleAmp = 3;
...
Opt.Rx.PD.Responsivity = Params.ICR.Responsivity;
Opt.Rx.PD.DarkCurrent = 10e-9;
Opt.Rx.PD.AddThermalNoise = 1;
Opt.Rx.PD.AddShotNoise = 1;
Opt.Rx.PD.BandWidth = Params.ICR.BandWidth;
