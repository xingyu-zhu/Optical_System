...
[E_Rx, SigX, SigY] = DEMO_model_OLT_Tx(Params);
...
%% ================== Splitter Module ==================
% --- Splitter Parameters ---
Params.Opt.Obj.Splitter.N = 4; % 1x4 Splitter
...
for n = 1:Params.Opt.Obj.Splitter.N
    ...
    [SNR_temp, BER_temp, ResData_temp] = DEMO_model_ONU_Rx(Params,SigX, SigY, E_Rx, Ports_Out, n);
