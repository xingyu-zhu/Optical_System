...
% Calculate Carrier Frequencies
% 将单载波中心频率偏移到右侧，为基带 0Hz 处的残余载波让路
...
% 6. Modulator
E_Tx_Out = Modulator_Module_load(E_Carrier, rf_out_x, rf_out_y, Params);
...
for idx = 1:Num_Points
    ...
    [IX, QX, IY, QY] = CoherentReceiver_load(E_Rx_Adjusted, E_LO_Rot, Params);
